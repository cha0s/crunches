...
| buffer    | [Prefix](#varuint-prefixes) followed by the bytes of the buffer                                                                                                                                                                                                                                                                                                                                                                                                                                   | Any `ArrayBuffer`<br /><br />Decodes to a `DataView`.<br /><br />See: [buffers and arrays](#buffers-and-arrays). |
